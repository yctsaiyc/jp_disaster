...
class ETL_VZSF51(ETL_jp_disaster):
    def xml_to_df(self, xml_path, soup):
        ...
        # タグ 解説
        # 
        # Title 標題。“地上実況図”“地上24時間予想図”“地上48時間予想図”“アジア太平洋地上実況図”“アジア太平洋海上悪天
        # 
        # 24時間予想図”“アジア太平洋海上悪天48時間予想図”のいずれかを記す。
        # ReportDateTime 発表時刻。“2012-01-10T05:00:00+09:00”のように日本標準時で記す。
        # TargetDateTime 基点時刻。“2012-01-10T03:00:00+09:00”のように日本標準時で記す。Title が“地上実況図”“アジア太平洋地上実況
        # 図”であれば、観測日時刻、“地上24時間予想図”“地上48時間予想図”“アジア太平洋海上悪天24時間予想図”“ア
        # ジア太平洋海上悪天48時間予想図”であれば数値予報初期値時刻を示す。
        # 
        # EventID 値は記述しない(空タグとする)。
        # InfoType 情報形態。“発表”“訂正”“取消”のいずれかを記す。
        # Serial 値は記述しない(空タグとする)。
        # InfoKind スキーマの運用種別情報。“天気図情報”で固定。
        # InfoKindVersion スキーマの運用種別情報のバージョン。本解説のバージョン番号は“1.1_1”。
        # Headline 見出し要素。
        # └ Text 値は記述しない(空タグとする)。
        # 
        # (3) Body 部の詳細
        # Body 部の Item タグ1つに対して1つの天気図要素を格納する。Item 以下は、ここでは概要のみとし、詳細は(4)内容部詳細で示す。
        # 
        # タグ 解説
        # 
        ...
        # └ MeteorologicalInfo
        # └ DateTime 天気図の対象となる時刻を、“2011-12-18T12:00:00+09:00”のように日本標準時で記す。例えば type が“予想 2
        # 
        # 4時間後”の場合は数値予報初期時刻から24時間後の時刻を示す。
        # └@type “実況”“予想 24時間後”“予想 48時間後”のいずれかを記す。
        # └ Item このタグ1つに対して1つの天気図要素または悪天情報要素を格納する。詳細は、(4)で示す。
        # └ Kind
        # └ Name MeteolorogicalInfos@type=“天気図情報”の場合は、このタグを省略する。
        # 
        # MeteorologicalInfos@type=“悪天情報”の場合は、悪天情報の種類“悪天情報(強風)”“悪天情報(霧)”“悪
        # 天情報(海氷)”“悪天情報(船体着氷)”のいずれかを記す。
        # 
        # └ Property MeteolorogicalInfos@type=“天気図情報”の場合、及び、MeteorologicalInfos@type=“悪天情報”で Item/Kind/Name=
        # 
        # “悪天情報(強風)”の場合に出現する。
        # MeteorologicalInfos@type=“悪天情報”で Item/Kind/Name= “悪天情報(霧)”“悪天情報(海氷)”“悪天情報(船
        # 体着氷)”の場合はこのタグを省略する。
        # 
        # └ Type 天気図要素名等。“台風”“熱帯低気圧”“低気圧”“高気圧”“低圧部”“前線”等の天気図要素の種類もしくは悪
        # 
        # 天情報の“風”、または“風”“呼称”“階級”等の要素を修飾する種別のいずれかを記す。
        # 
        # └ xxxPart 要素がもつ内容。Type により、“CenterPart”“WindSpeedPart”“TyphoonNamePart”“ClassPart”“CoodinatePart”
        # 
        # “IsobarPart”“WindPart”のいずれか1つを持つ。
        # 
        # └ Area MeteorologicalInfos@type=“悪天情報”の場合に出現し、悪天情報の対象領域を示す。Item/Kind/Name=“悪天情
        # 報(強風)”の場合、強風を表現する対象海上地点(Name と Coordinate)を示す。Item/Kind/Name=“悪天情報(霧)”
        # の場合、対象多角形領域(Name と Polygon)または対象海域(Name と Code)を示す。Item/Kind/Name=“悪天情報
        # (海氷)”または“悪天情報(船体着氷)”の場合、対象格子(0.5 度四方の領域)(Name と Coordinate)を示す。
        # 
        # └@codeType Item/Kind/Name=“悪天情報(霧)”において、海域を対象とする場合に“全般海上海域名”と記す。対象領域を Code
        # 
        # で示さない場合は省略する。
        # └ Name 悪天情報の対象領域名。
        # 
        ...
        # └ Code 悪天情報の対象領域コード。
        # 
        # Item/Kind/Name=“悪天情報(霧)”において、海域を対象とする場合は対応するコードを記す。全般海上海域名
        # “AreaMarineA”コード表が対応する。
        # └ jmx_eb:Polygon 悪天情報の対象多角形領域。
        # 
        # Item/Kind/Name=“悪天情報(霧)”において対象多角形領域を示す場合に、領域を囲む多角形の頂点を緯度経度で
        # 示す。
        # 
        # └jmx_eb:Coordinate 悪天情報の対象緯度経度値を示す。Item/Kind/Name=“悪天情報(強風)”の場合は、強風を表現する対象海上地点
        # を、Item/Kind/Name=“悪天情報(海氷)”または“悪天情報(船体着氷)”の場合は、対象格子の北西端の位置を、
        # 緯度経度で示す。
        # 
        # (4) 内容部詳細
